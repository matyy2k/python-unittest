...
class TestGetCodeWithDay(unittest.TestCase):
    ...
    @patch('random.randint')
    def test_get_code_with_day_today_date(self, mock_int):
    ...
    @patch('random.randint')
    def test_get_code_with_day_mocked_friday(self, mock_int, mock_day):
        mock_int.return_value = 5
    ...
    @patch('code_generator.get_today_name')
    @patch('random.randint')
    def test_get_code_with_day_mocked_sunday(self, mock_int, mock_day):
        mock_int.return_value = 5
