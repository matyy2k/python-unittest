...
class TestCalcTax(unittest.TestCase):
    ...
    def test_calc_tax_incorrect_age_should_raise_error(self):
        self.assertRaises(TypeError, calc_tax, 60000, 0.23, '5')

    def test_calc_tax_negative_age_should_raise_error(self):
        self.assertRaises(ValueError, calc_tax, 60000, 0.23, -5)

    def test_calc_tax_incorrect_type_amount_should_raise_error(self):
        self.assertRaises(TypeError, calc_tax, '60000', 0.23, 5)

    def test_calc_tax_negative_value_amount_should_raise_error(self):
        self.assertRaises(ValueError, calc_tax, -60000, 0.23, 5)
    ...
    def test_calc_tax_twenty_percent_and_sixty_age(self):
